...
export function CourseCard({ course }: CourseCardProps) {
    ...
    return (
        <Link
            ...
            className="group flex flex-col bg-card rounded-xl border border-border shadow-sm overflow-hidden transition-all hover:shadow-lg hover:border-primary/50 hover:-translate-y-1"
        >
            {/* Cover Image */}
            ...
            <div className="p-5 flex-1 flex flex-col">
                        ...
                        <span
                            ...
                            style={{
                                backgroundColor: primaryTag.color
                                    ? `${primaryTag.color}20`
                                    : "var(--secondary)",
                                color: primaryTag.color || "var(--secondary-foreground)",
                            }}
                        >
                            {primaryTag.name}
                        </span>
                ...
                {/* Title */}
                <h3 className="text-lg font-semibold leading-tight text-foreground mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                    {course.title}
                </h3>
...
export function CourseCardSkeleton() {
    return (
        <div className="flex flex-col bg-card rounded-xl border border-border shadow-sm overflow-hidden animate-pulse">
